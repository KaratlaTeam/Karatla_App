...
class _AcademyDetailPageState extends State<AcademyDetailPage>{
  ...
  void initState() {
    ...
    SystemUiOverlayStyle(
      ...
      statusBarIconBrightness: Brightness.light,///Only honored in Android version M and greater.
              ...
              delegate: SliverChildListDelegate([
                    ...
                    children: [
                      Container(
                        ...
                        child: IconButton(
                          ...
                          disabledColor: Colors.black,
                          onPressed: () async {
                            await MapsLauncher.launchQuery(widget.location);
                          },
                        ),
                      ),
                      Builder(
                        builder: (BuildContext context) {
                          return Container(
                              width:
                                  appDataModel.dataAppSizePlugin.scaleW * 320,
                              //height: ,
                              // margin: EdgeInsets.only(left: appDataModel.dataAppSizePlugin.scaleW*20, right: appDataModel.dataAppSizePlugin.scaleW*20, top: appDataModel.dataAppSizePlugin.scaleH*20),
                              child: InkWell(
                                child: Text(
                                ...
                                onLongPress: () {
                                  Clipboard.setData(
                                      ClipboardData(text: widget.location));
                ...
                Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      "assets/images/academy/academyMapExample.jpeg",
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
