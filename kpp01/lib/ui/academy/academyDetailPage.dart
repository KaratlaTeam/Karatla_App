          ...
          SliverList(
            delegate: SliverChildListDelegate([
              ...
              Container(
                height: appDataModel.dataAppSizePlugin.scaleW * 200,
                margin:
                    EdgeInsets.only(left: appDataModel.dataAppSizePlugin.scaleW * 10, right: appDataModel.dataAppSizePlugin.scaleW * 10, top: appDataModel.dataAppSizePlugin.scaleW * 20),
                child: Card(
                  child: Stack(
                    children: <Widget>[
                      Container(
