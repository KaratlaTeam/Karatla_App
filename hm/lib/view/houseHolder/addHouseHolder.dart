...
import 'package:hm/plugin/tencentQR/IDCardOCR.dart';
import 'package:hm/plugin/tencentQR/flutter_tencent_ocr.dart';
          ...
          children: [
            ...
            ElevatedButton(child: Text("创建"),onPressed: ()async{
              if(_checkInDate != null && _name != null && _idNum != null && _sex != null ){
                Get.find<HouseL>().addHouseHolder(_phoneNumber,Get.find<RoomL>().roomS.roomLevel,Get.find<RoomL>().roomS.roomIndex, _checkInDate, _temporaryIdStart, _temporaryIdEnd, _name, _idNum, _sex, _roomM.roomLevel, _roomM.roomNumber, _checkOutDate, _nation, _birth, _address, _mark, _image == null ? null : _image.path, _temporaryIdPhoto == null ? null : _temporaryIdPhoto.path);
                Get.back();
